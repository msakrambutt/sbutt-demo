          ...
          >
            {data.map((data: any) => {
              return (
                <div
                  key={data.product_id}
                  className="md:flex md:items-center md:gap-10 border md:w-full md:h-full"
                >
                  <div
                    id="product-image"
                    className="md:flex-start border md:h-100%"
                  >
                    <Image
                      src={urlForImage(data.image).url()}
                      className="md:w-[150px] md:h-[190px] rounded-lg"
                      alt=""
                      width={200}
                      height={200}
                    />
                  ...
                  >
                    <div
                      id="product-detail"
                      className="md:flex md:flex-col justify-between md:gap-4 border"
                    >
                    ...
                    {/* <div
                      id="counter-delete"
                      className="border md:flex md:justify-end  "
                    >
                      <div
                        id="TbTrash"
